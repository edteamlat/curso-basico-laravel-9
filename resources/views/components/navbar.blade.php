<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="#" class="flex items-center">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Blog de Jairo</span>
        </a>
        ...
        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                <li>
                    <a href="#" class="{{ request()->is('/') ? 'text-blue-700' : 'text-gray-700' }} block py-2 pr-4 pl-3 md:p-0">Inicio</a>
                </li>
                <li>
                    <a href="#" class="{{ request()->is('posts/*') ? 'text-blue-700' : 'text-gray-700' }} block py-2 pr-4 pl-3 md:p-0">Posts</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 md:p-0">Contacto</a>
                </li>
            </ul>
        </div>
    </div>
